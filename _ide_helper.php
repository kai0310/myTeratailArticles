...
namespace App\Facades { 
    ...
    class teratailAPI {
         ...
         * @static 
         */ 
        public static function callAPI($requestParam, $url, $page = 0)
        {
            return \App\Services\teratailAPI::callAPI($requestParam, $url, $page);
        }
    ...
    class utils {
         ...
         * @static 
         */ 
        public static function searchWord($articles, $searchWords)
        {
            return \App\Services\utils::searchWord($articles, $searchWords);
        }
...
namespace  { 
    ...
    class TeratailAPI extends \App\Facades\teratailAPI {}

    class URL extends \Illuminate\Support\Facades\URL {}

    class Utils extends \App\Facades\utils {}
